...
# so that it could say "create a new board object", or
...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        # initialize a set to keep track of which locations were dugged
    ...
    def make_new_board(self):
        ...
        #  [...                  ],
        #  [None, None, ..., None]]
        # we can see this represents this a board!
        ...
        while bombs_planted < self.num_bombs:
            ...
            if board[row][col] == '*':
                # this means that a bomb has already been planted there so keep going
                continue
    ...
    def assign_values_to_board(self):
        # now that the bombs have been planted, we will assign a number 0-8 for all empty spaces
...
def play(dim_size=10, num_bombs=10):
    # Step 1: Create e borad and plant the bombs
    board = Board(dim_size, num_bombs)
    # Step 2: Show the user the borad and ask where they want to sweep
    # Step 3a: Show the game over message if they digged up a bomb
    # Step 3b: Dig recursively until each square is at least next to a bomb
    # Step 4: Repeat steps 2 and 3a/3b until there are no more squares -> VICTORY
    safe = True

    while len(board.dug) < board.dim_size ** 2 - num_bombs:
        print(board)
        user_input = re.split(
            ',(\\s)*', input("Where do you wanna dig? Input as row,col: "))  # '0, 3'
